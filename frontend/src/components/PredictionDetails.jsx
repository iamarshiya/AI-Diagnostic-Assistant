    ...
    <div className="flex items-center gap-2">
      ...
      <main className="flex-grow flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/60 p-6 rounded-2xl border border-white/50 shadow-sm backdrop-blur-sm">
               <div className="flex justify-between items-end mb-2">
                 <span className="text-sm font-semibold text-slate-500 uppercase tracking-wider">AI Model Confidence</span>
          ...
          <div className={`bg-white rounded-3xl shadow-xl shadow-slate-200/40 border ${theme.border} p-8 md:p-10`}>
            ...
            <div className="space-y-4 pt-6 border-t border-slate-100">
               <div className="flex gap-3 items-start p-4 bg-slate-50 rounded-xl">
                  <svg className="w-5 h-5 text-slate-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                  <p className="text-xs text-slate-500 leading-normal">
                    <strong>Disclaimer:</strong> This result is generated by an AI model and serves as decision support only. It does not replace professional medical diagnosis.
                  </p>
               </div>
